...
public class TreeViewerComparator extends ViewerComparator {
	...
	public int category(Object element) {
		...
		return Activator.getInstance().getLabelProvider().getSortingCategory((IShadowEntity) element);
	}
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		...
		Integer result = Activator.getInstance().getLabelProvider().compare((IShadowEntity)e1, (IShadowEntity) e2);
		if (result == null)
			return super.compare(viewer, e1, e2);
		return result;
	}
