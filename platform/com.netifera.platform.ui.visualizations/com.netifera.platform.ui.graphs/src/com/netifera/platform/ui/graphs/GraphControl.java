...
*/
        ...
        forceLayout = new ForceDirectedLayout(GRAPH, forceSimulator, enforceBounds, !animateLayout);
...
//		synchronized (visualization) {
/*			if (!animateLayout)
			visualization.run("layout"); // or forceDirectedLayout.run() ???
*/		
			visualization.run("draw");
			embeddee.repaint();
//		}
