		...
		if (response.getStatusCode() == 401) {
			...
			if (header != null) {
				...
				if (method.toLowerCase().equals("basic")) {
					...
					factory.createWebPageWithBasicAuthentication(context.getRealm(), context.getSpaceId(), context.getSocketAddress(), context.getBaseURL().resolve(request.getURL()), authRealm);
				}
			}
		}
	}
